...
const MODEL_NAME = 'gemini-1.0-pro'; // Or whatever model name you find from the list
...
export const generateProjectHighlights = async (project, readmeContent, jobDescription) => {
    ...
    const systemPrompt = `You are an expert resume writer. Your task is to generate 2-3 concise, impactful bullet points for a resume project section. The bullet points should highlight the project's accomplishments and technologies, tailored specifically to the provided job description. Start each bullet point with a strong action verb.`;
